...
pub fn visit_ast_mut<'ast, S: Source, P: MutPass<'ast, S::Pointer>>(
    p: &mut P,
    ast: &'ast mut AST<S>,
) {
...
pub fn noop_module<'ast, Ptr: Pointer, P: MutPass<'ast, Ptr>>(
    v: &mut P,
    node: &'ast mut Module<Ptr>,
) {
...
pub fn noop_top_level_decl<'ast, Ptr: Pointer, P: MutPass<'ast, Ptr>>(
    v: &mut P,
    node: &'ast mut TopLevelDecl<Ptr>,
) {
    match node.kind {
...
pub fn noop_func_decl<'ast, Ptr: Pointer, P: MutPass<'ast, Ptr>>(
    v: &mut P,
    node: &'ast mut FuncDecl<Ptr>,
) {
...
pub fn noop_func_def<'ast, Ptr: Pointer, P: MutPass<'ast, Ptr>>(
    v: &mut P,
    node: &'ast mut FuncDef<Ptr>,
) {
...
pub fn noop_infix_def<'ast, Ptr: Pointer, P: MutPass<'ast, Ptr>>(
    v: &mut P,
    node: &'ast mut InfixDef<Ptr>,
) {
...
pub fn noop_func_call<'ast, Ptr: Pointer, P: MutPass<'ast, Ptr>>(
    v: &mut P,
    node: &'ast mut FuncCall<Ptr>,
) {
...
pub fn noop_infix_func_call<'ast, Ptr: Pointer, P: MutPass<'ast, Ptr>>(
    v: &mut P,
    node: &'ast mut InfixFuncCall<Ptr>,
) {
    v.visit_ident(&mut node.ident);
    v.visit_expr(&mut node.lhs);
...
pub fn noop_infix_op_call<'ast, Ptr: Pointer, P: MutPass<'ast, Ptr>>(
    v: &mut P,
    node: &'ast mut InfixOpCall<Ptr>,
) {
    v.visit_op(&mut node.op);
    v.visit_expr(&mut node.lhs);
    v.visit_expr(&mut node.rhs);
...
pub fn noop_paren<'ast, Ptr: Pointer, P: MutPass<'ast, Ptr>>(
    v: &mut P,
...
pub fn noop_func_type<'ast, Ptr: Pointer, P: MutPass<'ast, Ptr>>(
    v: &mut P,
    node: &'ast mut FuncType<Ptr>,
) {
